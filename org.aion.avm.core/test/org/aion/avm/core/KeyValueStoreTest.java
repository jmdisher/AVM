...
public class KeyValueStoreTest {
    ...
    public void testStorageBilling() {
        ...
        assertEquals(47716L + RuntimeMethodFeeSchedule.BlockchainRuntime_avm_getStorage + StorageFees.READ_PRICE_PER_BYTE * value.length, getStorageCost);
        kernel.generateBlock();
        ...
        assertEquals(47716L + RuntimeMethodFeeSchedule.BlockchainRuntime_avm_getStorage, getZeroCost);
