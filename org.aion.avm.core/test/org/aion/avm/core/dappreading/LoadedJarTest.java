...
public class LoadedJarTest {
    ...
    public void checkExpectedClassesReadFromJar() throws IOException {
        byte[] jarBytes = JarBuilder.buildJarForMainClassAndExplicitClassNamesAndBytecode(Main.class, Collections.emptyMap(), C1.class, C2.class, JavaAccessor.class, TestAnnotation.class, C3.class);
